...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", type=str, default="../models/codebert-base", help="Path to pretrained model")
    parser.add_argument("--train_java_bug_file", type=str, default="../datasets/CodeNet_java_bug_drop_repeat.csv", help="Java bug training data file")
    parser.add_argument("--train_java_clean_file", type=str, default="../datasets/CodeNet_java_clean_drop_repeat.csv", help="Java clean training data file")
    parser.add_argument("--train_python_bug_file", type=str, default="../datasets/CodeNet_python_bug_drop_repeat.csv", help="Python bug training data file")
    parser.add_argument("--train_python_clean_file", type=str, default="../datasets/CodeNet_python_clean_drop_repeat.csv", help="Python clean training data file")
    parser.add_argument("--max_seq_length", type=int, default=512, help="Maximum sequence length")
    parser.add_argument("--batch_size", type=int, default=8, help="Batch size")
    parser.add_argument("--accumulation_steps", type=int, default=32, help="Gradient accumulation steps")
    parser.add_argument("--max_java_clean_samples", type=int, default=305759, help="Maximum number of Java clean samples")
    parser.add_argument("--max_python_clean_samples", type=int, default=1387527, help="Maximum number of Python clean samples")
    parser.add_argument("--max_buggy_samples", type=int, default=10000, help="Maximum number of buggy samples")
    parser.add_argument("--max_clean_samples", type=int, default=10000, help="Maximum number of clean samples")
    ...
    parser.add_argument("--file_prefix", type=str, default="fine-tune_codenet", help="File prefix")
    parser.add_argument("--should_log", type=bool, default=True, help="Whether to log")
    parser.add_argument("--log_file_name", type=str, default="log_codenet", help="Log file name")
...
def load_data(args):
    ...
    df_java_bug = pd.read_csv(args.train_java_bug_file)
    df_java_clean = pd.read_csv(args.train_java_clean_file)
    df_python_bug = pd.read_csv(args.train_python_bug_file)
    df_python_clean = pd.read_csv(args.train_python_clean_file)
    ...
    clean_codes_java = clean_codes_java[:args.max_java_clean_samples]
    clean_codes_python = clean_codes_python[:args.max_python_clean_samples]
