...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default=None, help="Model path (if None, will be auto-generated)")
    parser.add_argument("--test_model", type=str, default="epoch_1", help="Test model checkpoint to use")
    
    # Data parameters
    parser.add_argument("--max_seq_length", type=int, default=512, help="Maximum sequence length")
    parser.add_argument("--batch_size", type=int, default=8, help="Batch size for testing")
    parser.add_argument("--java_true_csv", type=str, default="../datasets/cvefixes_java_true_drop_comments.csv", help="Path to Java true dataset")
    parser.add_argument("--java_false_csv", type=str, default="../datasets/cvefixes_java_false_drop_comments.csv", help="Path to Java false dataset")
    parser.add_argument("--python_true_csv", type=str, default="../datasets/cvefixes_python_true_drop_comments.csv", help="Path to Python true dataset")
    parser.add_argument("--python_false_csv", type=str, default="../datasets/cvefixes_python_false_drop_comments.csv", help="Path to Python false dataset")
    parser.add_argument("--java_false_limit", type=int, default=3102, help="Limit for Java false samples")
    parser.add_argument("--python_false_limit", type=int, default=2775, help="Limit for Python false samples")
...
def main():
    ...
    # Load datasets
    df_java_true = pd.read_csv(args.java_true_csv)
    df_java_false = pd.read_csv(args.java_false_csv)
    df_python_true = pd.read_csv(args.python_true_csv)
    df_python_false = pd.read_csv(args.python_false_csv)
    ...
    clean_codes_java = clean_codes_java[:args.java_false_limit]
    clean_codes_python = clean_codes_python[:args.python_false_limit]
