...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="codellama", help="Model name")
    ...
    parser.add_argument("--data_path", type=str, default="../datasets/merged_all_drop_comments.csv", help="Path to test data")
    ...
    if args.dataset_type == "comments":
        ...
        args.log_file_path = os.path.join(args.output_dir, args.model_name, f"{args.log_file_name}_comments.txt")
    else:
        args.file_prefix = "fine-tune-NOcomments"
        args.log_file_path = os.path.join(args.output_dir, args.model_name, f"{args.log_file_name}_NOcomments.txt")
