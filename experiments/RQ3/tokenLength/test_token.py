...
def parse_args():
    ...
    parser.add_argument("--test_model", type=str, default="epoch_20", help="Test model checkpoint to use")
    
    # Data parameters
    parser.add_argument("--data_path", type=str, default="../datasets/merged_all_2_3_dedupliacted2_dropna3_dropeq.csv", help="Path to the dataset")
    parser.add_argument("--comments", action="store_true", default=True, help="Whether to use comments in the data")
